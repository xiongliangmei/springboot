...
public class EmailTests {
    ...
    private static final String recipient = "xl9204@126.com" ;
    ...
    public void sendAttachmentEmail() {
        ...
        try {
            ...
            FileSystemResource file = new FileSystemResource(new File("src/main/resources/static/mao.jpg"));
            //加入邮件
    ...
    public void sendInlineResourceMail() {
        ...
        try {
            ...
            FileSystemResource res = new FileSystemResource(new File("src/main/resources/static/mao.jpg"));
